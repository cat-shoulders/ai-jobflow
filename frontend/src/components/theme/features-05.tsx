              ...
              <div className="absolute w-[200%] flex items-center justify-center space-x-5">
                <div className="-rotate-[4deg]">
                  <img
                    ...
                    src="/images/pricing-icon-01.svg"
                    width={80}
                    height={80}
                    alt="Pricing icon 01"
                  />
                ...
                <div className="rotate-[4deg]">
                  <img
                    ...
                    src="/images/pricing-icon-02.svg"
                    width={80}
                    height={80}
                    alt="Pricing icon 02"
                  />
                ...
                <div className="-rotate-[4deg]">
                  <img
                    ...
                    src="/images/pricing-icon-03.svg"
                    width={80}
                    height={80}
                    alt="Pricing icon 03"
                  />
                ...
                <img
                  ...
                  src="/images/pricing-icon-04.svg"
                  width={80}
                  height={80}
                  alt="Pricing icon 04"
                />
                <div className="rotate-[4deg]">
                  <img
                    className="w-16 h-16 drop-shadow-lg animate-[float_2.2s_ease-in-out_infinite] opacity-60"
                    src="/images/pricing-icon-05.svg"
                    width={80}
                    height={80}
                    alt="Pricing icon 05"
                  />
                ...
                <div className="-rotate-[4deg]">
                  <img
                    className="w-14 h-14 drop-shadow-lg animate-[float_2.4s_ease-in-out_infinite] opacity-25"
                    src="/images/pricing-icon-06.svg"
                    width={80}
                    height={80}
                    alt="Pricing icon 06"
                  />
                ...
                <div className="rotate-[4deg]">
                  <img
                    ...
                    src="/images/pricing-icon-07.svg"
                    width={80}
                    height={80}
                    alt="Pricing icon 07"
                  />
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-linear-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-slate-400">
                  ...
                  <strong className="text-slate-300 font-medium">simple plan</strong>{' '}
            ...
            <div className="bg-linear-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
              <div className="flex items-center space-x-4 p-4 h-full">
                ...
                <p className="text-sm text-slate-400">
                  There's no prioritized support in Stellar. You can use email or
