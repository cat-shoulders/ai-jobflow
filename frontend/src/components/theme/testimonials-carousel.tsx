        ...
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <h2 className="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Spot CV issues before it gets late
            </h2>
            <p className="text-lg text-slate-400">
              Most of your CV rejections are due to a lack of information related to
              the job description not selling all the key skills. We can help you
              spot those issues before it gets late.
            </p>
          </div>
