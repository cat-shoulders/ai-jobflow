        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1
              ...
              data-aos="fade-down"
            >
              The ultimate Job application process platform
            </h1>
            <p
              ...
              data-aos-delay="200"
            >
              We help you build, fix, improve and manage your job application
              process.
            </p>
            <div
            ...
            >
              <div>
                ...
                >
                  <svg
                    className="shrink-0 fill-slate-800 mr-3"
                  ...
                  Get Started{' '}
                  <span className="bg-amber-600 text-white px-1 py-0.5 rounded-md ml-2 text-[10px] font-semibold transition-colors">
                    Free
                  </span>{' '}
                  <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                    -&gt;
