        ...
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              In a world where people are constantly looking for new opportunities,
              it's important to have a clear understanding of what you're looking
              for. With our platform, you can easily have full control over your job
              application process.
            </p>
          </div>
                        ...
                        <div className="mb-5">
                          <div>
                            <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">
                              With any position you have
                            </h3>
                            <p className="text-slate-400">
                              Our AI-powered platform is designed to be flexible and
                              adaptable to any position you have. Whether you're a
                              senior developer, a marketer, or a data scientist,
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Keep track of your job applications and interviews with a
                            simple dashboard. No more guessing what's going on.
                          </p>
                        </div>
                      </div>
                      {/* img */}
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Our platform can be easily integrated with any
                            third-party tool. Connect your linkedin and we will do
                            the rest.
                          </p>
                        </div>
                      </div>
