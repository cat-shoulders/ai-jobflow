  ...
  const items: Item[] = [
    {
      ...
      quote:
        'This platform was a life saver for me. I was able to find some wholes in my resume and apply them to my job application.',
      name: 'Jessie J',
    ...
    },
    {
      ...
      quote:
        "It's a great tool for anyone looking to improve their resume and find their ideal job.",
      name: 'Mark Luk',
      role: 'Scrum Master',
    },
    {
      ...
      quote:
        "As a busy professional, I don't have a lot of time to keep my resume up to date. But with this tool, I have seen amazing results in just a few short weeks. The workouts are efficient and effective.",
      name: 'Jeff Kahl',
              ...
              <div className="relative flex flex-col" ref={testimonials}>
                {items.map((item, index) => (
                  <Transition
                    ...
                    appear={true}
                  >
                    <div className="text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60">
                      {item.quote}
                    </div>
                  </Transition>
                ))}
